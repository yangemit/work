...
dd if=$T31_FIRMWARE_DIR/uboot-t31L-0618 of=$OUT/$TARGET &&
dd if=$T31_FIRMWARE_DIR/uImage-0608 of=$OUT/$TARGET bs=1k seek=256 &&
dd if=$T31_FIRMWARE_DIR/rootfs_for_ucamera of=$OUT/$TARGET bs=1k seek=2816 &&
