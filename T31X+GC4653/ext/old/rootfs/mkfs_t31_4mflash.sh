...
dd if=$T31_FIRMWARE_DIR/u-boot-with-spl.bin of=$OUT/$TARGET &&
dd if=$T31_FIRMWARE_DIR/uImage-0514 of=$OUT/$TARGET bs=1k seek=256 &&
dd if=$T31_FIRMWARE_DIR/rootfs.squashfs of=$OUT/$TARGET bs=1k seek=1536 &&
dd if=$OUT/appfs.jffs2 of=$OUT/$TARGET bs=1k seek=2560
