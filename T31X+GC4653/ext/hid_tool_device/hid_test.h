...
#define HSB_READ_PRODUCTNUMBER		   (HID_SN_BURNING + 0x020)
...
#define HSB_WRITE_APPKEY                  (HID_SN_BURNING + 0xf21)


#define MANUFACTURE 	                  0x200
#define SREIALNUMBER			  0x201
#define PRODUCTNUMBER			  0x202
#define VID 			 	  0x203
#define PID 			 	  0x204
#define BCD			 	  0x205
...
#define UPDATE_UVCCONFIG_PATH             "/system/config/uvc.config"
#define UPDATE_UVCATTR_PATH               "/system/config/uvc.attr"
