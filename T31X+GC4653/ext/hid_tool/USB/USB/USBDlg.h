...
#define HID_BASIC_INFO_READ_VERSION         (HID_COMMON_USAGE + 0x001)
...
protected:
	...
	afx_msg void OnBnClickedButtonReadAppkey();
	afx_msg void OnBnClickedButtonWriteAppkey();
...
private:
	...
	CEdit m_editReadVersion;
	CEdit m_editReadAppKey;
