...
int main(int argc, const char* argv[])
{
	...
	{
		printf("action：\n");
		printf("1:MOTOR_STOP 2:MOTOR_RESET 3:MOTOR_MOVE 4:MOTOR_GET_STATUS 5:MOTOR_SPEED 6:MOTOR_GOBACK 7:MOTOR_CRUISE 8:MOTOR_PWR\n");
		printf("choose:");
		scanf("%d",&d);
		switch(d)
		{
			...
			case MOTOR_PWR:
				{
					...
					printf("motor pwr: ");
					scanf("%d",&motor_pwr);
					ioctl(fd, d, (unsigned long)&motor_pwr);
					printf("pwr=%d\n",motor_pwr);
					break;
				}
