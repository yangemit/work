...
static const struct UVC_FRAME_MJPEG(3) uvc_frame_mjpg_360p = {
	...
	.dwFrameInterval[0]	= cpu_to_le32(333333),
	.dwFrameInterval[1]	= cpu_to_le32(666666),
	.dwFrameInterval[2]	= cpu_to_le32(777777),
};
...
static const struct UVC_FRAME_MJPEG(1) uvc_frame_mjpg_960p = {
	.bLength		= UVC_DT_FRAME_MJPEG_SIZE(1),
	.bDescriptorType	= USB_DT_CS_INTERFACE,
	.bDescriptorSubType	= UVC_VS_FRAME_MJPEG,
	.bFrameIndex		= 2,
...
static const struct UVC_FRAME_MJPEG(1) uvc_frame_mjpg_4mp = {
	.bLength		= UVC_DT_FRAME_MJPEG_SIZE(1),
	.bDescriptorType	= USB_DT_CS_INTERFACE,
	.bDescriptorSubType	= UVC_VS_FRAME_MJPEG,
	.bFrameIndex		= 5,
...
static struct uvc_format_framebased uvc_format_h265 = {
	.bLength		= UVC_DT_FORMAT_FRAMEBASED_SIZE,
	.bDescriptorType	= USB_DT_CS_INTERFACE,
	.bDescriptorSubType	= UVC_VS_FORMAT_FRAME_BASED,
	.bFormatIndex		= 3,
...
static const struct UVC_FRAME_FRAMEBASED(2) uvc_frame_h264_360p = {
...
int uvc_set_descriptor(unsigned long arg)
{
	...
	struct UVC_FRAME_MJPEG(1) *frame_mjpeg = NULL;
	struct UVC_FRAME_FRAMEBASED(1) *frame_h264_5 = NULL;
	...
	while (iformat < nformat) {
		...
		case V4L2_PIX_FMT_MJPEG:
			...
			frame_header = &uvc_frame_mjpg_360p;
			break;
		case V4L2_PIX_FMT_H264:
			...
			frame_header = &uvc_frame_h264_360p;
			break;
		case V4L2_PIX_FMT_H265:
			uvc_format_h265.bFormatIndex = iformat + 1;
			uvc_format_h265.bNumFrameDescriptors = nframe;
			ucamera_streaming_cls[cnt] = &uvc_format_h265;
			frame_header = &uvc_frame_h264_360p;
			break;
		}
		...
		while (iframe < uvc_formats[iformat]->nframe) {
			...
			case V4L2_PIX_FMT_NV12:
				...
				break;
			case V4L2_PIX_FMT_MJPEG:
				frame_mjpeg = (struct UVC_FRAME_MJPEG(1) *)ucamera_streaming_cls[cnt];
				...
				frame_mjpeg->dwFrameInterval[2] = cpu_to_le32(frame[iframe].intervals[2]);
			...
			case V4L2_PIX_FMT_H264:
			case V4L2_PIX_FMT_H265:
				frame_h264_5 = (struct UVC_FRAME_FRAMEBASED(1) *)ucamera_streaming_cls[cnt];
				frame_h264_5->wWidth = cpu_to_le16(frame[iframe].width);
				frame_h264_5->wHeight = cpu_to_le16(frame[iframe].height);
				frame_h264_5->bFrameIndex = iframe + 1;
				frame_h264_5->dwFrameInterval[0] = cpu_to_le32(frame[iframe].intervals[0]);
				frame_h264_5->dwFrameInterval[1] = cpu_to_le32(frame[iframe].intervals[1]);
				break;
			}
