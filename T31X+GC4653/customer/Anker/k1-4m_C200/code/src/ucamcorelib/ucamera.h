...
#define UVC_EXTENSION_UNIT_ID		6
...
#else
#define UCAMERA_VIDEO_DEV 			"/dev/video3"
#endif
...
#define MEMERASE                _IOW('M', 2, struct erase_info)
...
#define UPGATE_SIGNATURE              	(0x55504454)
