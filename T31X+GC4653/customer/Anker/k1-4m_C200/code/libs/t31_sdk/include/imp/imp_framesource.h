...
typedef enum {
	IMP_FSCHANNEL_STATE_CLOSE, /**< fs通道未创建或已关闭销毁*/
	IMP_FSCHANNEL_STATE_OPEN,  /**< fs通道已创建，未使能*/
	IMP_FSCHANNEL_STATE_RUN,   /**< fs通道已创建，已使能*/
} IMPFSChannelState;
 ...
 *
 * 通过channel ID 获取framesource通道的创建状态；0：未创建，1：通道创建，2：通道正在运行.
 *
 * @param[in] chnNum       通道编号.
 *
 * @retval  >=0            成功.
