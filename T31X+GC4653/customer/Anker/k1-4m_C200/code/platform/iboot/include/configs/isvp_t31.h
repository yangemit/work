...
#define CONFIG_SYS_VPLL_FREQ            1152000000      /*If MPLL not use mast be set 0*/
#define CONFIG_SYS_VPLL_MNOD            ((288 << 20) | (2 << 14) | (3 << 11) | (1<<8))
...
#ifdef CONFIG_PRODUCT_ARES
#define MAX_U_IMAGE_LIMIT	(1024 * 1024 * 2) // 2MB
#else
#define MAX_U_IMAGE_LIMIT	(1024 * 1024 * 1) // 4MB
#endif
