...
int jz_serial_init(void)
{
	...
	jz_serial_puts("Serial init OK!");

	/* PB 19 */
	/* *(volatile unsigned int *)(0xb0011000 + 0x18) = (1 << 19); //PCINTC 0 */
	/* *(volatile unsigned int *)(0xb0011000 + 0x24) = (1 << 19); //PCMSKS 1 */
	/* *(volatile unsigned int *)(0xb0011000 + 0x38) = (1 << 19); //PCPAT1C 0 */

	/* // PB 19 output low */
	/* *(volatile unsigned int *)(0xb0011000 + 0x48) = (1 << 19); //PCPAT0C 1 */
