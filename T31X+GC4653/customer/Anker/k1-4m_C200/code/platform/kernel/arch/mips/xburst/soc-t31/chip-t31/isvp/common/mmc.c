...
struct jzmmc_platform_data tf_pdata = {
 ...
 struct jzmmc_platform_data sdio_pdata = {
	 .removal  			= MANUAL,
	 .sdio_clk			= 1,
	 .ocr_avail			= MMC_VDD_165_195 | MMC_VDD_29_30 | MMC_VDD_30_31,
#ifdef CONFIG_PRODUCT_DIVA
	 .capacity  			= MMC_CAP_4_BIT_DATA | MMC_CAP_SDIO_IRQ| MMC_CAP_NONREMOVABLE | MMC_CAP_SD_HIGHSPEED | MMC_CAP_MMC_HIGHSPEED,
#else
