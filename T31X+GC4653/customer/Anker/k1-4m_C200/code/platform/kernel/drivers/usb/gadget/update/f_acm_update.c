...
int acm_mod_init(void)
{
	...
	ret =  userial_init();
	if(ret)
		printk("userial_init if false\n");

	return usb_function_register(&acmusb_func);
}
EXPORT_SYMBOL(acm_mod_init);

void  acm_mod_exit(void)
{
