...
/* hik define */
#define UVC_FAST_SHUTTER                                        0x0c
#define UVC_HVFLIP_CONTROL                                      0x0d
#define UVC_S_EXPOSURE_TIME_CONTROL                             0x0f
#define UVC_S_AUTO_EXPOSURE_MODE_CONTROL                        0x10
#define UVC_S_FOCUS_CONTROL                                     0x11
#define UVC_S_FOCUS_AUTO_CONTROL                                0x12
#define UVC_S_DENOISE_CONTROL                                   0x13
#define UVC_S_ZOOM_ABSOLUTE_CONTROL                             0x14
#define UVC_S_IMAGEMODE_CONTROL                                 0x15
#define UVC_S_STANDARD_CONTROL                                  0x16
#define UVC_S_AFGRADE_CONTROL                                   0x17
...
#define UVC_SUPPORT_1_FRAMES            0x1
#define UVC_SUPPORT_2_FRAMES            0x2
#define UVC_SUPPORT_4_FRAMES            0x4


/* Audio config */
#define AUDIO_OUT_SAMPLE_RATE			48000
#define AUDIO_OUT_SAMPLE_TIME			20
#define AUDIO_OUT_BUF_SIZE			(AUDIO_OUT_SAMPLE_RATE * sizeof(short) * AUDIO_OUT_SAMPLE_TIME / 1000)
//#define AUDIO_PCM_SIZE				1920
#define AUDIO_PCM_SIZE				640
...
struct Ucamera_Video_EU_Control {
	int type;
	int cmd;
	char data[8][32];                         /* data[UVC_CUR] - data[UVC_DEF], MAX 32bit */
	int len;                                  /* eu len */
	int (*set)(int cs, void *data, int len);
	int (*get)(int cs, int req, void *data, int len);
};
