...
static unsigned int UCAMERA_VENDOR_ID   =  0x05A7;	/* Linux Foundation */
static unsigned int UCAMERA_PRODUCT_ID  =  0x9334;	/* Ucam A/V gadget */
static unsigned int UCAMERA_DEVICE_BCD  =  0x0100;	/* 0.10 */


#define STRING_DESCRIPTION_IDX		USB_GADGET_FIRST_AVAIL_IDX

static char ucamera_vendor_label[64] = "HID Semiconductor CO., LTD.";
static char ucamera_product_label[64] = "HID DEVICE";
static char ucamera_serial_label[64] = "Ucamera001";
static char ucamera_config_label[] = "ucamera";
char video_device_name[64] = "ucamera";
...
static unsigned int acm_start = 1;
...
{
	printk("=================gpio_control================\n");
	/* PB02  input pull down*/
	*(volatile unsigned int *)(0xb0010100 + 0x18) = (1 << 2); //INT 0
	*(volatile unsigned int *)(0xb0010100 + 0x24) = (1 << 2); //MSKS 1
	*(volatile unsigned int *)(0xb0010100 + 0x34) = (1 << 2); //PAT1 1
	*(volatile unsigned int *)(0xb0010100 + 0x44) = (1 << 2); //PAT0 1

	*(volatile unsigned int *)(0xb0010100 + 0x124) = (1 << 2); //PULL-DOWN

	/* PB30  input pull down*/
	*(volatile unsigned int *)(0xb0010100 + 0x18) = (1 << 30); //INT 0
	*(volatile unsigned int *)(0xb0010100 + 0x24) = (1 << 30); //MSKS 1
	*(volatile unsigned int *)(0xb0010100 + 0x34) = (1 << 30); //PAT1 1
	*(volatile unsigned int *)(0xb0010100 + 0x44) = (1 << 30); //PAT0 0

	*(volatile unsigned int *)(0xb0010100 + 0x124) = (1 << 30); //PULL-DOWN
	printk("=================gpio_control================\n");
	return NULL;
