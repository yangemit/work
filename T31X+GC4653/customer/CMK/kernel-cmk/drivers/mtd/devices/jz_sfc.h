...
/*used for GD25Q127C  register  */
#define SPINOR_OP_WRSR_EN        0x50
#define SPINOR_OP_READ_UID	0x4B
#define SPINOR_OP_READ_SECURITY	0x48
#define SPINOR_OP_WRITE_SECURITY	0x42
#define SPINOR_OP_ERASE_SECURITY	0x44
#define CONFIG_MTD_SPI_NOR_FLASH_OTP 
...
#define SR_BP4			0x40	/* Block protect 4 */
