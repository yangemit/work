...
EXPORT_SYMPOL(cnt1_be);
EXPORT_SYMPOL(cnt2_be);
EXPORT_SYMPOL(cnt3_be);
EXPORT_SYMPOL(cnt4_be);
EXPORT_SYMPOL(cnt5_be);
EXPORT_SYMPOL(cnt6_be);
EXPORT_SYMPOL(cnt7_be);
EXPORT_SYMPOL(cnt8_be);
EXPORT_SYMPOL(cnt1_af);
EXPORT_SYMPOL(cnt2_af);
EXPORT_SYMPOL(cnt3_af);
EXPORT_SYMPOL(cnt4_af);
EXPORT_SYMPOL(cnt5_af);
EXPORT_SYMPOL(cnt6_af);
EXPORT_SYMPOL(cnt7_af);
EXPORT_SYMPOL(cnt8_af);
