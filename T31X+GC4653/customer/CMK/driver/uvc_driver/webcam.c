...
int uvc_camera_terminal_en = 0;
module_param(uvc_camera_terminal_en, int, S_IRUGO);
...
static const struct UVC_EXTENSION_UNIT_DESCRIPTOR(1, 4) uvc_extersion_unit = {
...
int ucam_bind_uvc(struct usb_configuration *c)
{
	...
	if (uvc_camera_terminal_en){
		uvc_camera_terminal.bmControls[0] = 0x2a;
		uvc_camera_terminal.bmControls[1] = 0x00;
