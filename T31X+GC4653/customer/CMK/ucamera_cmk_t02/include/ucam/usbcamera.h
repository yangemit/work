...
int Ucamera_Video_Regesit_Camera_Termina_CB(struct Ucamera_Video_CT_Control *ctctl[]);
...
int xu_req_process_usr(uint8_t cs, void *data, int slen, void *res, int *rlen);
int xu_req_set_GetLen(uint8_t cs, void *res);
#endif /* _USBCAMERA_H_ */
