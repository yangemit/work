...
#endif
	*(volatile unsigned int *)(0xb0011000 + 0x128) = (1 << 28); //PULL-DOWN
	/* PB28  output height*/
	*(volatile unsigned int *)(0xb0011000 + 0x18) = (1 << 28); //INT 0
	*(volatile unsigned int *)(0xb0011000 + 0x24) = (1 << 28); //MSKS 1
	*(volatile unsigned int *)(0xb0011000 + 0x38) = (1 << 28); //PAT1 0
	*(volatile unsigned int *)(0xb0011000 + 0x44) = (1 << 28); //PAT0 1
