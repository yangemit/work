...
struct uvc_format_info uvc_formats_h265 = {
...
int Ucamera_Config(struct Ucamera_Cfg *ucfg)
{
	...
	while (i < vcfg->jpegnum) {
		...
		frame[cnt].intervals[2] = 10000000 / 25;
	...
	if (1 == ucfg->h264_en || 1 == ucfg->h265_en) {
	...
	if(1 == ucfg->h265_en)
	{
		uvc_formats_h265.nframes = uvc_formats_h264.nframes;
		uvc_formats_h265.frames  = uvc_formats_h264.frames;
		uvc_formats[2] = &uvc_formats_h265;
	}
	if(1 == ucfg->h265_en && 1 == ucfg->h264_en)
	{
		uvc_formats_h264.nframes = uvc_formats_h264.nframes;
		uvc_formats_h264.frames  = uvc_formats_h264.frames;
		uvc_formats[2] = &uvc_formats_h264;
	}
